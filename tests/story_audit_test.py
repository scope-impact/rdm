...
class TestCheckIds:
    ...
    @pytest.mark.skipif(os.geteuid() == 0, reason="root ignores file permissions; chmod 000 cannot make the file unreadable")
    def test_logs_warning_on_file_error(self, capsys: object) -> None:
...
# =============================================================================
# SYNC TESTS - See tests/backlog_sync_test.py for new Backlog.md sync tests
# =============================================================================
# The old YAML-based sync tests have been removed.
# New sync functionality is tested in tests/backlog_sync_test.py
